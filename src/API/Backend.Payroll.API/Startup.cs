using Backend.Payroll.API.Bootstrapper;
using MediatR;
...
namespace Backend.Payroll.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = $"Backend.Payroll.API", Version = "v1" });
